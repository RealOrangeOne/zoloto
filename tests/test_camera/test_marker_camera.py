...
from tests.strategies import marker_types, reasonable_image_size
...
@given(strategies.integers(0, 25))
...
def test_camera_as_context_manager(marker_type) -> None:
    with MarkerCamera(25, marker_size=200, marker_type=marker_type) as marker_camera:
...
@given(strategies.integers(0, 25), marker_types())
...
def test_process_eager_frame_without_calibrations(marker_type) -> None:
    ...
    marker_camera = TestCamera(25, marker_size=200, marker_type=marker_type)
