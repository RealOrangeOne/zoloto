...
def test_marker_pixel_corners(benchmark, marker):
    benchmark(get_uncached_marker_func(marker, "pixel_corners"))
...
def test_marker_cartesian(benchmark, marker):
    benchmark(get_uncached_marker_func(marker, "cartesian"))


def test_marker_spherical(benchmark, marker):
    benchmark(get_uncached_marker_func(marker, "spherical"))
